...
unicycler -1 ./trimgalore/*_1.fq -2 ./trimgalore/*_2.fq -o assembly_output -t 190
...
prokka --outdir annotated_genome --kingdom bacteria --cpus 190 --prefix annotated_genome --locustag annotated_genome ./assembly_output/assembly.fasta
